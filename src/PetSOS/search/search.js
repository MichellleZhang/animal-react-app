                                ...
                                <div key={pet.id} className="card card-body mb-3">
                                    ...
                                    <div className="row">
                                        <div className="col-md-8">
                                            ...
                                            <Link to={`/details/${pet._id}`} state={{localSearchResults:localPets}} className="btn btn-primary">
                                                View Details
                                            </Link>
                            ...
                            <div key={pet.id} className="card card-body mb-3">
                                ...
                                <div className="row">
                                    <div className="col-md-8">
                                        ...
                                        <Link to={`/details/${pet.id}`} state={{remoteSearchResults:apiPets}} className="btn btn-primary">
                                            View Details
                                        </Link>
                                    </div>
                                    <div className="col-md-4">
